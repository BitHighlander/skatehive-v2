      ...
      >
        ...
        >
          <HStack>
            ...
            <a
              href="https://giveth.io/project/skatehive-skateboarding-community"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Text color="chartreuse" fontSize="12px">
                {" "}
                Join Giveth's Quadratic Funding Round, your donation w/ super
                powers!{" "}
              </Text>
            </a>
