...
const ProposalModal: React.FC<ProposalModalProps> = ({
  ...
  const [positiveOpinion, setPositiveOpinion] = useState<string>(
    "Loading positive opinion..."
  );
  const [negativeOpinion, setNegativeOpinion] = useState<string>(
    "Loading negative opinion..."
  );
    ...
    try {
      ...
      const positiveResponse = await openai.chat.completions.create({
        messages: [
          {
            role: "system",
            content: "You are a helpful assistant that generates opinions.",
          },
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      >
        <ModalHeader color="orange" fontSize="42px">
          {proposalTitle}
        </ModalHeader>
        <Divider />
        <ModalCloseButton />
          ...
          <Tabs variant="soft-rounded" defaultIndex={1}>
            <TabList justifyContent="center">
              <Tab
                ...
                _selected={{ bg: "green.400", border: "1px solid white" }}
              >
                Ai generated LOVE ❤
              </Tab>
              <Tab
                ...
                _selected={{ bg: "teal", border: "1px solid white" }}
              >
                Proposal
              </Tab>
              <Tab bg="black" border="1px solid red" _selected={{ bg: "pink" }}>
                Ai generated HATE💔
              </Tab>
            </TabList>
            <TabPanels>
              <TabPanel>
                <center>
                  <Image
                    boxSize="120px"
                    src="https://cdn3.emoji.gg/emojis/6156_pepe_angel.png"
                  />
                  <Text
              ...
              <TabPanel>
                <center>
                  <Image
                    boxSize="120px"
                    src="https://i.ibb.co/fq343qf/image.png"
                  />
