...
const AccSummary: React.FC<AccSummaryProps> = ({ username }) => {
  ...
  useEffect(() => {
    if (username.length > 0) getSummary();
  }, [username]);
      ...
      <VStack spacing={4} align="stretch">
        <Tooltip label={`Total value generated by @${username}`}>
          <Flex alignItems="center" justifyContent="center" padding="10px">
            <Image src="https://www.gnars.wtf/images/logo.png" boxSize="40px" />
            <Text
              textAlign="center"
              borderRadius="12px"
              fontWeight="700"
        ...
        >
          ...
          <Text fontWeight="bold" fontSize="48px">
            {!isLoading
              ? `$${(voteRewards + currationRewards * conversionRate).toFixed(
                  2
                )}`
              : ""}
          </Text>
        ...
        <HStack spacing={4} align="stretch">
          <BalanceDisplay
            label="Vote Rewards"
            balance={
              voteRewards ? `${voteRewards.toFixed(3)} HBD` : "Loading..."
            }
        ...
        >
          <Text color="white" fontSize="16px">
            These stats are only from the account @{username} and do not include
            the vote trail that have been set up to support the skatehive
            community which increases the value of total rewards given out.
          </Text>
        </HStack>
      </VStack>
    </Box>
