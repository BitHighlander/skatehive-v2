...
import type * as Types from "../home/Feed/types";

const VotingBox: React.FC<Types.PostFooterProps> = ({
  onClose,
  author,
  permlink,
  weight = 10000,
    ...
    >
      <Box width="100%" marginBottom="20px" position="relative">
        ...
        >
          ...
          <span role="img" aria-label="Skateboard" style={skateEmojiStyle}>
            {emojiByAmount[sliderValue.toString()]}
          </span>
        </Slider>
