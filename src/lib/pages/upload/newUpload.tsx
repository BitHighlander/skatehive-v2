...
} from "../utils/videoFunctions/videoUtils";
  ...
  const handleHiveUpload = async () => {
    ...
    if (user && title) {
      ...
      if (username) {
        ...
        if (includeFooter) {
          const finalPermlink = videoPermlink || permlink;
    ...
    <Box>
      ...
      <Flex minWidth="100%" flexDirection={isMobile ? "column" : "row"}>
        ...
        >
          ...
          <Flex flexDirection={isMobile ? "column" : "row"}>
            <Box flex={1}>
              ...
              >
                <Checkbox
                  isDisabled={!!(videoFile || uploadedVideo)}
        ...
        >
          ...
          <ReactMarkdown
            children={transformComplexMarkdown(
              transformGiphyLinksToMarkdown(
                transform3SpeakContent(transformYouTubeContent(markdownText))
              )
            )}
            components={{
