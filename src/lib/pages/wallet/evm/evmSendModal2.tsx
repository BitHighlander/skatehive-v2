...
const EvmSendModal2: React.FC<EvmSendModalProps> = ({
  isOpen,
  onClose,
  tokenInfo,
}) => {
  ...
  const sendToAddress = async function (
        ...
        <ModalHeader>
          <Grid templateColumns="1fr auto" gap={4} alignItems="center">
            ...
            <VStack spacing={4} align="left">
              ...
              <Button
                colorScheme="green"
                onClick={(event) => sendToAddress(event)}
              >
                Send
              </Button>
            </VStack>
        ...
        <ModalBody>
          <VStack spacing={4} align="left">
            ...
            <Text color="white">
              ...
              <Badge> {tokenInfo.contract}</Badge>
            </Text>
            <Text color="white">
            ...
            <Text color="white">
              ...
              <Badge> {tokenInfo.marketCap} USD</Badge>
            </Text>
            <Text color="white">
            ...
            <Text color="white">
              ...
              <Badge> {tokenInfo.dailyVolume} USD </Badge>
            </Text>
            <Divider />
