...
const AuthorProfilePage = React.lazy(
  () => import("lib/pages/profile/authorProfile")
);
...
const Test = React.lazy(
  () => import("lib/pages/home/dao/components/ethereum/gnarsDelegation")
);
const GnarsStats = React.lazy(
  () => import("lib/pages/home/dao/components/hiveGnars/gnars")
);
...
const Members = React.lazy(
  () => import("lib/pages/home/dao/components/steemskate/subscribers")
);
const GnarsDelegation = React.lazy(
  () => import("lib/pages/home/dao/components/ethereum/gnarsDelegation")
);
const GnarsHolders = React.lazy(
  () => import("lib/pages/home/dao/components/ethereum/gnarsDelegation2")
);
const AccountCreation = React.lazy(
  () => import("lib/pages/secret-spot/AccountCreation")
);
